...
The available opportunity presented to a Customer under one Private Feedback Eligibility.
_Avoid_: Private Feedback, Customer Review

**Private Feedback**:
A Customer's first-party, non-public response about an eligible Paid Order, including its optional Private Feedback Score. It is distinct from a public Customer Review or Trustpilot Review.
_Avoid_: Review, Rating, Trustpilot Review

**Private Feedback Score**:
The non-public scored assessment contained in Private Feedback.
...
**Rating**:
The scored assessment contained in a Customer Review.
