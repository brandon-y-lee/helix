...
export default async function CatalogVerificationPage({ searchParams = Promise.resolve({}) }: {
  ...
  return <CatalogVerification view="catalog" state={state as CatalogVerificationState} />;
}
