...
- **Trust & Policy → Catalog & Discovery, People & Access, and Ordering & Payment**: a Product Waitlist Enrollment records a Product-specific notification choice without changing Catalog Status, Merchandising Status, or Inventory Status or creating a Product Offer, Account, Cart, or Order.
